    ...
    const handleClick = () => {
        ...
        history.push({
            ...
            state: {
                ...
                streetAddress: props.location.state.streetAddress,
                province: props.location.state.province,
                cityTown: props.location.state.cityTown,
                postalCode: props.location.state.postalCode,
        ...
        <div>
            <div style={{top: 10, left: 10, position: 'relative'}}>
                <Breadcrumbs aria-label="breadcrumb">
                    ...
                    <Link color="textSecondary" href={SHIPPING_ROUTE}>
                        Shipping
                    </Link>
            ...
            >
                ...
                <Grid item container direction={'row'} justify={'flex-end'} style={{width: 500, marginBottom: 10}}>
                    <Grid item>
                        <Button variant={'contained'} color={'primary'} size={'large'} style={{width: 300}} onClick={handleClick}>
                            Place order
                        </Button>
                    </Grid>
                </Grid>
