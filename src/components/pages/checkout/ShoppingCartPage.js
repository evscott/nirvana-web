...
import {DASHBOARD_ROUTE, SHIPPING_ROUTE} from "../../../routes";
        ...
        return (
            <div className={classes.content}>
                ...
                >
                    ...
                    <Grid item>
                        <Button variant={'contained'} color={'primary'} size={'large'} style={{width: 300}} onClick={() => history.push({pathname: SHIPPING_ROUTE, state: {}})}>
                            Proceed to shipping
                        </Button>
                    </Grid>
                </Grid>
